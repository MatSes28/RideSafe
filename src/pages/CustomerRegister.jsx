         ...
         <div className="relative z-10 flex flex-col h-full justify-between">
           ...
           <div className="flex-1 flex flex-col justify-center mt-12">
             <h1 className="text-5xl xl:text-7xl font-black text-white mb-6 leading-[1.05] tracking-tight drop-shadow-lg">
               Join <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00A86B] to-[#34d399]">RideSafe.</span>
             </h1>
             ...
             <div className="flex flex-col gap-5">
                <div className="flex items-center gap-5 text-white font-bold bg-white/5 p-5 rounded-2xl border border-white/10 backdrop-blur-md max-w-md shadow-2xl transition-all hover:bg-white/10 hover:-translate-y-1">
                   <div className="bg-[#00A86B]/20 p-3 rounded-xl shadow-inner border border-[#00A86B]/30">
                     <Map className="text-[#34d399] w-6 h-6 shrink-0"/>
                   </div>
                   <span className="text-lg">Live map tracking & fast booking</span>
                </div>
                <div className="flex items-center gap-5 text-white font-bold bg-white/5 p-5 rounded-2xl border border-white/10 backdrop-blur-md max-w-md shadow-2xl transition-all hover:bg-white/10 hover:-translate-y-1">
                   <div className="bg-[#00A86B]/20 p-3 rounded-xl shadow-inner border border-[#00A86B]/30">
                     <Shield className="text-[#34d399] w-6 h-6 shrink-0"/>
                   </div>
                   <span className="text-lg">Strict driver background checks</span>
                </div>
             </div>
           </div>
           ...
           <div className="w-full max-w-[460px] mx-auto bg-white p-8 sm:p-10 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-2 mt-2">
                  ...
                  <label className={`flex flex-col items-center justify-center border-2 border-dashed rounded-2xl p-6 cursor-pointer transition-all ${idFile ? 'border-[#00A86B] bg-[#00A86B]/5' : 'border-slate-300 bg-slate-50 hover:bg-slate-100 hover:border-[#00A86B]/50'}`}>
                    <UploadCloud className={`mb-3 ${idFile ? 'text-[#00A86B]' : 'text-slate-400'}`} size={32} />
                ...
                <div className="flex flex-col gap-2 mt-2">
                  ...
                  <label className={`flex flex-col items-center justify-center border-2 border-dashed rounded-2xl p-6 cursor-pointer transition-all ${selfieFile ? 'border-[#00A86B] bg-[#00A86B]/5' : 'border-slate-300 bg-slate-50 hover:bg-slate-100 hover:border-[#00A86B]/50'}`}>
                    <UploadCloud className={`mb-3 ${selfieFile ? 'text-[#00A86B]' : 'text-slate-400'}`} size={32} />
                    <span className="font-bold text-slate-700 text-center mb-1">
